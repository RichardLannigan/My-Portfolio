...
namespace PhysicsEngine
{
	...
	protected:
		...
		PxRigidDynamic* rightFlipper_actor;
		PxRigidDynamic* leftFlipper_actor;
		PxRigidDynamic* lid;
		PxRigidDynamic* springPlunger_actor;
	...
	public:
		...
		PxRigidDynamic* GetRightFlipper();
		PxRigidDynamic* GetLeftFlipper();
		PxRigidDynamic* GetPlunger();
		PxRigidDynamic* GetSpringPlunger();
