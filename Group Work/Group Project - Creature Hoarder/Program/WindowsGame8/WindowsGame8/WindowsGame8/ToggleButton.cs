...
{
    class TButton : Sprite//TODO make a toggle button
    {
        Color textColour;
        ...
        public TButton(Game game, string name, Vector2 position, Texture2D texture, int states, SpriteFont spriteFont)
